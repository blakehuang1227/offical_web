      ...
      <div class="block">
        ...
        <div class="item-wrap">
          <div class="left-text">
            ...
            <div>
              <input class="join-us" type="buttom" value="加入我們" />
            </div>
          </div>
  ...
  head() {
    return {
      ...
      meta: [
        ...
        { hid: "關於我們", name: "關於我們", content: "關於我們" },
        {
          hid: "og:image",
          property: "og:image",
          content: ""
...
.section2 {
  ...
  .block1 {
    background: linear-gradient(90deg, #ffd032 0.15%, #ffb219 100%);
